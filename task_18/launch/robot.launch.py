...
def generate_launch_description():
    ...
    world_path = os.path.join(get_package_share_directory(package_name),'worlds', 'sumo_maze_world.sdf')
    params_file_path = os.path.join(get_package_share_directory(package_name),'config', 'mapper_params_online_async.yaml')
    # Launch Arguments
